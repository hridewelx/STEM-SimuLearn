...
const simulationComponents: Record<
  string,
  React.LazyExoticComponent<React.ComponentType<any>>
> = {
  diffusion: React.lazy(
    () => import("../simulations/chemistry/Diffusion/DiffusionSimulation")
  ),
  "reaction-lab": React.lazy(
    () => import("../simulations/chemistry/ReactionLab/ReactionLabSimulation")
  ),
  "le-chatelier": React.lazy(
    () => import("../simulations/chemistry/LeChatelier/LeChatelierSimulation")
  ),
  "convex-lens": React.lazy(
    () => import("../simulations/physics/ConvexLens/ConvexLensSimulation")
  ),
  "concave-mirror": React.lazy(
    () => import("../simulations/physics/ConcaveMirror/ConcaveMirrorSimulation")
  ),
...
const SimulationRunnerPage = () => {
  const { category, simulationId } = useParams<{
    category: string;
    simulationId: string;
  }>();
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              >
                ...
                <span className="text-sm font-medium">
                  {t("simulation_runner.back_to_details")}
                </span>
              </Link>
            ...
            <Link
              ...
              title={t("simulation_runner.close_title")}
            >
              <X className="w-5 h-5" />
            </Link>
          </div>
