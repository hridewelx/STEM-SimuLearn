...
const ReactionLabSimulation = () => {
  ...
  const [params, setParams] = useState<ReactionLabParams>(
    defaultReactionLabParams
  );
    ...
    <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1 bg-gray-900/80 rounded-xl p-1 border border-gray-700/50">
            ...
            >
              ...
              <span className="hidden sm:inline">
                {t("reactionLab.viewMode.molecular")}
              </span>
            </button>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              />
              {isRunning
                ? t("reactionLab.status.running")
                : t("reactionLab.status.ready")}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="lg:hidden flex gap-2">
        ...
        >
          ...
          <span>{t("reactionLab.panels.controls")}</span>
        </button>
        <button
          onClick={() =>
        ...
        >
          ...
          <span>{t("reactionLab.panels.analytics")}</span>
        </button>
      </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="font-semibold text-white">
                    {viewMode === "visual"
                      ? t("reactionLab.canvas.visualLab")
                      : t("reactionLab.canvas.molecularSim")}
                  </h2>
                </div>
                <div className="flex items-center gap-3">
                  {/* Progress Bar */}
                  ...
                  {isFullscreen && (
                    <div className="flex items-center gap-1 bg-gray-900/80 rounded-lg p-1 border border-gray-700/50">
                      <button
                        ...
                        title={
                          isRunning
                            ? t("reactionLab.actions.pause")
                            : t("reactionLab.actions.start")
                        }
                      >
                        {isRunning ? (
                      ...
                      <button
                        ...
                        title={t("reactionLab.actions.reset")}
                      >
                  ...
                  <button
                    ...
                    title={
                      isFullscreen
                        ? t("reactionLab.actions.exitFullscreen")
                        : t("reactionLab.actions.expand")
                    }
                  >
                    {isFullscreen ? (
