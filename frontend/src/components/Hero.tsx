      ...
      <div className="relative container mx-auto px-4 pt-20 pb-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8">
            <div className="leading-none">{t("hero.title_part1")}</div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <Link
              to="/simulations"
              className="group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-2xl font-semibold text-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 flex items-center gap-3"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 max-w-2xl mx-auto">
            {[
              { number: "50+", label: t("hero.stats.simulations") },
              { number: "10K+", label: t("hero.stats.students") },
              { number: "100+", label: t("hero.stats.modules") },
              { number: "4.9/5", label: t("hero.stats.rating") },
            ].map((stat, index) => (
            ...
            {[
              {
                ...
                experiments: t("hero.subjects.physics_count"),
              },
              {
                name: t("nav.chemistry"),
                icon: <Beaker className="w-8 h-8" />,
                color: "from-green-500 to-emerald-500",
                experiments: t("hero.subjects.chemistry_count"),
              },
              {
                name: t("nav.biology"),
                icon: <Dna className="w-8 h-8" />,
                color: "from-purple-500 to-pink-500",
                experiments: t("hero.subjects.biology_count"),
              },
              {
                name: t("nav.math"),
                icon: <Calculator className="w-8 h-8" />,
                color: "from-orange-500 to-red-500",
                experiments: t("hero.subjects.math_count"),
              },
            ].map((subject) => (
              <div
                key={subject.name}
